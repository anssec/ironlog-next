...
export default function EditProfileModal({ user, onClose, onUpdate, toast }) {
  ...
  return (
    <Modal title="Edit Profile" onClose={onClose}>
      {error && <div style={{ background:'rgba(239,68,68,.1)', border:'1px solid rgba(239,68,68,.2)', borderRadius:'8px', padding:'10px 14px', fontSize:'13px', color:'var(--red)', marginBottom:'14px' }}>{error}</div>}
      ...
      <div style={{ fontFamily:'Bebas Neue,sans-serif', fontSize:'16px', letterSpacing:'1px', marginBottom:'12px', color:'var(--text2)' }}>CHANGE PASSWORD</div>
